...
public class BookServiceImpl implements BookService {
    ...
    public BookDto insert(BookCreateDto book) {
        Book savedBook = save(0L, book.title(), book.authorId(), book.genreIds());
        return bookMapper.toDto(savedBook);
    }

    @Override
    @Transactional
    public BookDto update(long id, BookUpdateDto book) {
        Book savedBook = save(id, book.title(), book.authorId(), book.genreIds());
        return bookMapper.toDto(savedBook);
    }
